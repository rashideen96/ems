    	...
    	<div class="row">
    		<div class="col-lg-4">
	    		...
	    		<div class="col-lg-8">
	    			...
	    			<div class="form-group">
	    				<label>IC No</label>
	    				<input type="number" name="ic_no" class="form-control form-control-sm rounded-0">
	    			</div>
	    			<div class="form-group">
	    				<label>Date of Birth</label>
	    				<input type="text" id="datepicker" name="dob" class="form-control form-control-sm rounded-0" autocomplete="off">
	    			</div>
	    			<div class="form-group">
	    				<label>Joined Date</label>
	    				<input type="text" id="datepicker2" name="joined_date" class="form-control form-control-sm rounded-0" autocomplete="off">
	    			</div>
	    			<div class="form-group">
	    				<label>Email</label>
	    			...
	    			<div class="form-group">
	    				...
	    				<input type="text" name="phone_no" class="form-control form-control-sm rounded-0">
	    			</div>
	    			<hr>
	    			<div class="form-group">
